...
{{--    <h2>@lang('app.filterResults')</h2>--}}
    ...
    <div class="white-box" style="display:none">
        <div class="row m-b-10">
            ...
            <div class="col-md-3">
                <h5 class="box-title m-t-30">@lang('modules.taskCategory.taskCategory')</h5>
...
{{--                            <a href="{{ route('admin.taskboard.index') }}" class="btn btn-inverse btn-sm hidden-sm hidden-xs"><i class="ti-layout-column3" aria-hidden="true"></i> @lang('modules.tasks.taskBoard')</a>--}}
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('admin.all-tasks.data') !!}?clientID='+clientID +'&assignedBY='+ assignedBY+'&assignedTo='+ assignedTo+'&status='+ status+'&category_id='+ category_id+'&_token={{ csrf_token() }}';
