                ...
                <div class="white-box">
                    <nav>
                        <ul>
                            ...
                            <li class="tab-current"><a href="{{ route('admin.lead-report.conversion-project') }}"><span>@lang('app.menu.conversionToProject')</span></a>
    ...
    function showTable() {
        ...
        table = $('#tasks-table').dataTable({
            ...
            columns: [
                ...
                {data: 'project', name: 'projects.project_name'},
