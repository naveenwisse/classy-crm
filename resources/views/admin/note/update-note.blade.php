<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('app.update') @lang('modules.note.note')</h4>
</div>
<div class="modal-body">
    <div class="portlet-body">

        {!! Form::open(['id'=>'editNote','class'=>'ajax-form','method'=>'POST']) !!}
        <div class="form-body">
            <div class="row">
                <div class="col-xs-12 ">
...
<script>
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: '{{route('admin.note.update-note', $note->id)}}',
            container: '#editNote',
            type: "POST",
