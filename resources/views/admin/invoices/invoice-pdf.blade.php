        ...
        <tr>
            <td>
                <div id="invoiced_to">
                    ...
                    <h2 class="name">{{ ucwords($invoice->project->client->client[0]->company_name) ?? ucwords($invoice->project->client->name) }}</h2>
                    <div>{!! nl2br($invoice->project->client->client[0]->address) !!}</div>
                        @if($invoiceSetting->show_gst == 'yes' && !is_null($invoice->project->client->client[0]->gst_number))
                            <div> @lang('app.gstIn'): {{ $invoice->project->client->client[0]->gst_number }} </div>
                        @endif
                    @endif
...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="invoice">
            ...
            <div class="date">@lang("app.date"): {{ $invoice->issue_date->format($global->date_format) }}</div>
        </div>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($taxes as $tax)
            <tr style="page-break-inside: avoid;" class="tax">
                ...
                <td class="unit">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ number_format((float)$tax->amount, 2, '.', '') }}</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
