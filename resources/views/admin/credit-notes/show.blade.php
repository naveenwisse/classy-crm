    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="white-box printableArea ribbon-wrapper">
                @if($invoiceExist && $creditNote->invoice_id)<a href="{{ route('admin.all-invoices.show', $creditNote->invoice_id) }}" class="btn btn-info pull-right">@lang('app.viewInvoice')</a>@endif
