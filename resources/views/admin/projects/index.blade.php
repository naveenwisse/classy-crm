...
{{--                            --}}
{{--                            <a href="{{ route('admin.projects.gantt') }}" class="btn btn-outline btn-danger btn-sm hidden-xs hidden-sm"><i class="fa fa-bar-chart" aria-hidden="true"></i> @lang('modules.projects.viewGanttChart')</a>--}}
{{--                            --}}
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover toggle-circle default footable-loaded footable" id="project-table">
                        ...
                        <tr>
                            ...
                            <th>@lang('modules.projects.clientName')</th>
