<div class="col-sm-12">
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 c-white m-t-10"><strong>{{__('messages.installationProgress')}}: </strong> {{$progressPercent}}%
                </div>
            </div>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="list-group lg-alt">
                <div class="list-group-item media">
                    ...
                    <div class="media-body">
                        <div class="widget-title"><a href="{{route('admin.email-settings.index')}}" class="">{{__('messages.installationStep2')}}</a>
                        </div>
            ...
            <div class="list-group lg-alt">
                <div class="list-group-item media">
                    ...
                    <div class="media-body">
                        <div class="widget-title"><a href="{{route('admin.settings.index')}}">{{__('messages.installationStep3')}}</a></div>
            ...
            <div class="list-group lg-alt">
                <div class="list-group-item media">
                    ...
                    <div class="media-body">
                        <div class="widget-title"><a href="{{route('admin.profile-settings.index')}}" class="">{{__('messages.installationStep4')}}</a>
                        </div>
