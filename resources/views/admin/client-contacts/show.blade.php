                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="{{ route('admin.contacts.show', $client->id) }}"><span>@lang('app.menu.contacts')</span></a>
                                </li>
                                @if($gdpr->enable_gdpr)
                                    <li><a href="{{ route('admin.clients.gdpr', $client->id) }}"><span>@lang('modules.gdpr.gdpr')</span></a>
                                @endif
                            </ul>
                        </nav>
                    </div>
