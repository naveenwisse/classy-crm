        ...
        <div class="navbar-header">
            ...
            <div class="top-left-part">
                ...
                <a class="logo hidden-xs hidden-sm text-center" href="{{ route('client.dashboard.index') }}">
                    ...
                    <img src="{{ $global->logo_url }}" alt="home" class=" client-logo"/>
...
<!-- Left navbar-header end -->
    ...
    <div id="page-wrapper">
        ...
        <!-- /.container-fluid -->
        <footer class="footer text-center"> {{ \Carbon\Carbon::now()->year }} &copy; {{ $companyName }}
            @if($gdpr->enable_gdpr &&  $gdpr->terms_customer_footer)
                <a href="{{route('client.gdpr.terms')}}"> Terms and condition</a>
            @endif
        </footer>
