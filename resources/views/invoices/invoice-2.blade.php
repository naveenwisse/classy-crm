        ...
        <section id="sums">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr class="amount-total">
                    <th>
                        <hr>@lang("modules.invoices.total") @lang("modules.invoices.paid"):</th>
                    <td>
                        <hr>{!! htmlentities($invoice->currency->currency_symbol)  !!}@if($invoice->status == 'paid' && $paidAmount == 0){{ $invoice->total }} @else {{ $paidAmount }} @endif</td>
                </tr>
                <tr class="amount-total">
                    <th>
                        <hr>@lang("modules.invoices.total") @lang("modules.invoices.due"):</th>
                    <td>
                        <hr>{!! htmlentities($invoice->currency->currency_symbol)  !!}@if($invoice->status == 'paid' && $paidAmount == 0) 0 @else {{ max(($invoice->total-$paidAmount),0) }} @endif</td>
                </tr>
                <tr class="amount-total">
                    <th>
