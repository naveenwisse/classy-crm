    ...
    <div class="right-creditNote">
        ...
        <section id="creditNote-title-number">
            ...
            <div class="title-top">
                ...
                <span>{{ $creditNote->issue_date->format("dS M Y") }}</span>
            </div>
        ...
        <section id="creditNote-info">
            @if($creditNote->status == 'unpaid')
                <div>
                    <span>Due Date:</span> <span>{{ $creditNote->due_date->format("dS M Y") }}</span>
                </div>
            @endif
                @if($invoiceNumber)
                    <div>
        ...
        <section id="items">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th>@lang("modules.credit-note.item")</th>
                    <th>@lang("modules.credit-note.qty")</th>
                    <th>@lang("modules.credit-note.unitPrice")</th>
                    <th>@lang("modules.credit-note.price")</th>
                </tr>
