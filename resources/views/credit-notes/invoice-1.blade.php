...
<head>
    ...
    <title>{{ $creditNote->cn_number }}</title>
    <style>
...
<main>
    <div id="details" class="clearfix">
        ...
        <div id="creditNote">
            ...
            <div class="date">@lang('app.menu.issues') Date: {{ $creditNote->issue_date->format("dS M Y") }}</div>
            @if($creditNote->status == 'unpaid')
                <div class="date">@lang('app.dueDate'): {{ $creditNote->due_date->format("dS M Y") }}</div>
            @endif
            @if($invoiceNumber)
