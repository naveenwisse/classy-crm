    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.all-credit-notes.index') }}">@lang("app.menu.credit-note")</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="white-box bg-success">
                ...
                <ul class="list-inline two-part">
                    <li><i class="fa fa-money text-white"></i></li>
                    <li class="text-right"><span class="counter text-white">{{ $creditNote->currency->currency_symbol}} @if($creditNote->status == 'paid' && $paidAmount == 0){{ $creditNote->total }} @else {{ $paidAmount }} @endif</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
            <div class="white-box bg-danger">
                ...
                <ul class="list-inline two-part">
                    <li><i class="fa fa-money text-white"></i></li>
                    <li class="text-right"><span class="counter text-white">{{ $creditNote->currency->currency_symbol}} @if($creditNote->status == 'paid' && $paidAmount == 0) 0 @else {{ max(($creditNote->total-$paidAmount),0) }} @endif</span></li>
                </ul>
            </div>
        </div>
        <div class="col-md-12">
            ...
            <div class="white-box printableArea ribbon-wrapper">
                @if($invoiceExist && $creditNote->invoice_id)<a href="{{ route('designer.all-invoices.show', $creditNote->invoice_id) }}" class="btn btn-info pull-right">@lang('app.viewInvoice')</a>@endif
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-right">
                                ...
                                <a class="btn btn-default btn-outline"
                                   href="{{ route('designer.all-credit-notes.download', $creditNote->id) }}"> <span><i class="fa fa-file-pdf-o"></i> @lang('modules.credit-notes.downloadPdf')</span> </a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function () {
        var table = $('#credit-notes-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{{ route('designer.all-credit-notes.create') }}',
            deferRender: true,
            "order": [[0, "desc"]],
            language: {
    ...
    function showPayments() {
        var url = '{{route('designer.all-credit-notes.payment-detail', $creditNote->id)}}';
