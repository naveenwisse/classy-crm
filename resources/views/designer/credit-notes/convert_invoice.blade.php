    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.all-credit-notes.index') }}">{{ __($pageTitle) }}</a></li>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="taxes[]" class="form-control type">
                                                        <option value="">@lang('zero') @lang('modules.invoices.tax')</option>
...
<script>
    ...
    $('#save-form').click(function(){
        ...
        $.easyAjax({
            url:'{{route('designer.all-credit-notes.store')}}',
...
//            calculate total
    ...
    $('#tax-settings').click(function () {
        var url = '{{ route('designer.taxes.create')}}';
    ...
    $('.add-product').on('click', function(event) {
        ...
        var id = $(this).data('pk');
        $.easyAjax({
            url:'{{ route('designer.all-credit-notes.update-item') }}',
            type: "GET",
            data: { id: id },
