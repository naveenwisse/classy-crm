...
{{--                            <a href="{{ route('designer.all-credit-notes.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.credit-notes.addCreditNote') <i class="fa fa-plus" aria-hidden="true"></i></a>--}}
                ...
                <div class="modal-body">
                    <div class="row" id="file-dropzone">
                        <div class="row m-b-20" id="file-dropzone">
                            <div class="col-md-12">
                                <form action="{{route('designer.creditNoteFile.store')}}"
                                      class="dropzone"
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.all-credit-notes.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#credit-notes-table').dataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: '{!! route('designer.all-credit-notes.data') !!}?startDate=' + startDate + '&endDate=' + endDate + '&projectID=' + projectID,
            "order": [[ 0, "desc" ]],
            language: {
