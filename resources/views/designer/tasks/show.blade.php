            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        ...
                        <nav>
                            <ul>
                                    <li><a href="{{ route('designer.projects.show', $project->id) }}"><span>@lang('modules.projects.overview')</span></a></li>
                                    @if(in_array('employees',$modules))
                                    <li><a href="{{ route('designer.project-members.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>
                                    @endif
    
                                    @if(in_array('tasks',$modules))
                                    <li class="tab-current"><a href="{{ route('designer.tasks.show', $project->id) }}"><span>@lang('app.menu.tasks')</span></a></li>
                                    @endif
    
                                    <li><a href="{{ route('designer.files.show', $project->id) }}"><span>@lang('modules.projects.files')</span></a></li>
                                    @if(in_array('timelogs',$modules))
                                    <li><a href="{{ route('designer.time-log.show-log', $project->id) }}"><span>@lang('app.menu.timeLogs')</span></a></li>
                                    @endif
                            </ul>
                        </nav>
                    </div>
...
<script type="text/javascript">
    ...
    function showTable() {
        var url = '{!!  route('designer.tasks.data', [':projectId']) !!}?_token={{ csrf_token() }}';
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('#save-task').click(function () {
        $.easyAjax({
            url: '{{route('designer.tasks.store')}}',
    ...
    taskListPanel.on('click', '.edit-task', function () {
        var id = $(this).data('task-id');
        var url = "{{route('designer.tasks.edit', ':id')}}";
        url = url.replace(':id', id);
    ...
    $('#sort-task, #hide-completed-tasks').change(function() {
        ...
        var url = "{{route('designer.tasks.sort')}}";
        var token = "{{ csrf_token() }}";
