    ...
    <div class="row">
        ...
        <div class="sttabs tabs-style-line col-md-12">
            <div class="white-box">
                <nav>
                    <ul>
                        <li><a href="{{ route('designer.leaves.index') }}"><span>@lang('modules.leaves.myLeaves')</span></a>
                        </li>
                        <li class="tab-current"><a href="{{ route('designer.leaves-dashboard.index') }}"><span>@lang('app.menu.dashboard')</span></a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <div class="col-md-7">
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <a href="{{ route('designer.leaves-dashboard.create') }}" class="btn btn-sm btn-success waves-effect waves-light  pull-right">
...
<script>
    ...
    var getEventDetail = function (id) {
        var url = '{{ route('designer.leaves-dashboard.show', ':id')}}';
