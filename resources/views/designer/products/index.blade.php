                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <a href="{{ route('designer.products.create') }}" class="btn btn-outline btn-success btn-sm">@lang('app.addNew') @lang('app.menu.products') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                @endif
    ...
    <script>
        $(function() {
            var table = $('#products-table').dataTable({
                ...
                serverSide: true,
                stateSave: true,
                ajax: '{!! route('designer.products.data') !!}',
                language: {
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('designer.products.destroy',':id') }}";
