                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            @if($user->can('add_estimates'))
                                <a href="{{ route('designer.estimates.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.estimates.createEstimate') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @endif
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.estimates.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('designer.estimates.data') !!}?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status,
            "order": [[ 0, "desc" ]],
            language: {
