...
@push('footer-script')
    ...
    <script>
        ...
        function loadTable(){
            ...
            var url = '{!!  route('designer.leave-report.data', [':startDate', ':endDate', ':employeeId']) !!}';
        ...
        $('#leave-table').on( 'click', '.view-approve', function (event) {
            ...
            var id = $(this).data('pk');
            var url = '{{ route('designer.leave-report.show', ':id') }}?startDate=' + startDate + '&endDate=' + endDate;
        ...
        $('#leave-table').on( 'click', '.view-pending', function (event) {
            ...
            event.preventDefault();
            var id = $(this).data('pk');
            var url = '{{ route('designer.leave-report.pending-leaves', ':id') }}?startDate=' + startDate + '&endDate=' + endDate;
            url = url.replace(':id', id);
            $.ajaxModal('#leave-details', url);
        });
        ...
        $('#leave-table').on( 'click', '.view-upcoming', function (event) {
            ...
            event.preventDefault();
            var id = $(this).data('pk');
            var url = '{{ route('designer.leave-report.upcoming-leaves', ':id') }}?startDate=' + startDate + '&endDate=' + endDate;
            url = url.replace(':id', id);
            $.ajaxModal('#leave-details', url);
        });
        ...
        $('#leave-table').on( 'click', '.exportUserData', function (event) {
            ...
            var url = '{{ route('designer.leave-report.export', [ ':id', ':startDate', ':endDate']) }}';
            url = url.replace(':startDate', startDate);
            url = url.replace(':endDate', endDate);
            url = url.replace(':id', id);
