...
<script>
    ...
    $('#filter-results').click(function () {
        ...
        var url = '{{ route('designer.task-report.store') }}';
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('designer.task-report.data', [':startDate', ':endDate', ':employeeId', ':projectId']) !!}';
    ...
    function exportData(){
        ...
        var url = '{!!  route('designer.task-report.export', [':startDate', ':endDate', ':employeeId', ':projectId']) !!}';
