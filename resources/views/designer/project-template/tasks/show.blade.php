            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        ...
                        <nav>
                            <ul>
                                <li ><a href="{{ route('designer.project-template.show', $project->id) }}"><span>@lang('modules.projects.overview')</span></a>
                                </li>
                                <li><a href="{{ route('designer.project-template-member.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>
                                <li class="tab-current"><a href="{{ route('designer.project-template-task.show', $project->id) }}"><span>@lang('app.menu.tasks')</span></a></li>
                            </ul>
                        </nav>
                    </div>
...
<script type="text/javascript">
    ...
    $('#save-task').click(function () {
        $.easyAjax({
            url: '{{route('designer.project-template-task.store')}}',
    ...
    taskListPanel.on('click', '.edit-task', function () {
        ...
        var url = "{{route('designer.project-template-task.edit', ':id')}}";
