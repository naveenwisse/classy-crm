                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group action">
                            <a href="{{ route('designer.project-template.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.projectTemplate.addNewTemplate') <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    $(function() {
        table =  table.dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('designer.project-template.data') !!}',
            "order": [[ 0, "desc" ]],
            deferRender: true,
            language: {
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.project-template.destroy',':id') }}";
