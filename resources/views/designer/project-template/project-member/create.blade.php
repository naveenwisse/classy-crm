    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.project-template.index') }}">{{ $pageTitle }}</a></li>
            ...
            <section>
                <div class="sttabs tabs-style-line">
                    <div class="white-box">
                        <nav>
                            <ul>
                                <li><a href="{{ route('designer.project-template.show', $project->id) }}"><span>@lang('modules.projectTemplate.overview')</span></a>
                                </li>
                                <li class="tab-current"><a href="{{ route('designer.project-template-member.show', $project->id) }}"><span>@lang('modules.projectTemplate.members')</span></a></li>

                                <li><a href="{{ route('designer.project-template-task.show', $project->id) }}"><span>@lang('app.menu.tasks')</span></a></li>
                            </ul>
                        </nav>
                    </div>
...
<script type="text/javascript">
    ...
    $('#save-members').click(function () {
        $.easyAjax({
            url: '{{route('designer.project-template-member.store')}}',
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: '{{route('designer.project-template-members.storeGroup')}}',
            container: '#saveGroup',
            type: "POST",
...
$('body').on('click', '.delete-members', function(){
    ...
    swal({
        ...
        if (isConfirm) {
            ...
            var url = "{{ route('designer.project-template-member.destroy',':id') }}";
