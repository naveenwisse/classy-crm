...
@push('footer-script')
    <script>
       ...
       // Delete Holiday
        function del(id, date) {
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.holidays.destroy',':id') }}";
        ...
        function showAdd() {
            var url = "{{ route('designer.holidays.create') }}";
            $.ajaxModal('#edit-column-form', url);
        }
        // Show Create Holiday Modal
        function showMarkHoliday() {
            var url = "{{ route('designer.holidays.mark-holiday') }}";
            $.ajaxModal('#edit-column-form', url);
        }
        ...
        function showData() {
            var year = $('#year').val();
            var url = "{{ route('designer.holidays.view-holiday',':year') }}"
            url = url.replace(':year', year);
            $.easyAjax({
                type: 'GET',
                url: url,
