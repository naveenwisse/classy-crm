    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.holidays.index') }}">@lang('app.menu.holiday')</a></li>
...
<script>
    ...
    var getEventDetail = function (id) {
        var url = '{{ route('designer.holidays.show', ':id')}}';
...
<script>
    ...
    function setMonthData(d){
        ...
        var year = "{{ $year }}";
        var url = "{{ route('designer.holidays.calendar-month') }}?startDate="+firstDay+"&year="+year;
    ...
    function getYearData(){
        var year = $('#year').val();
        var url = "{{ route('designer.holidays.calendar', ':year') }}";
