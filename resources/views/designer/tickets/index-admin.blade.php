                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <a href="{{ route('designer.tickets.create') }}"
...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('designer.tickets.refreshCount', [':startDate', ':endDate', ':agentId', ':status', ':priority', ':channelId', ':typeId']) !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('designer.tickets.adminData', [':startDate', ':endDate', ':agentId', ':status', ':priority', ':channelId', ':typeId']) !!}';
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('designer.tickets.destroy',':id') }}";
