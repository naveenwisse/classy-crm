    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.ticket-agent.index') }}">{{ $pageTitle }}</a></li>
...
<script>
    ...
    $('.apply-template').click(function () {
        ...
        $.easyAjax({
            url: '{{route('designer.ticket-agent.fetchTemplate')}}',
            type: "POST",
    ...
    $('.submit-ticket').click(function () {
        ...
        $.easyAjax({
            url: '{{route('designer.ticket-agent.update', $ticket->id)}}',
