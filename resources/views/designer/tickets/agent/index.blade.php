...
<script>
    ...
    function showTable() {
        ...
        var url = '{!!  route('designer.ticket-agent.refreshCount', [':startDate', ':endDate', ':status', ':priority', ':channelId', ':typeId']) !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('designer.ticket-agent.data', [':startDate', ':endDate', ':status', ':priority', ':channelId', ':typeId']) !!}';
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('designer.ticket-agent.destroy',':id') }}";
