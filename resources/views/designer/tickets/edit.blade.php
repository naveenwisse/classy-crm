    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.tickets.index') }}">{{ $pageTitle }}</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xs-10 col-md-11">
                                            <h4 class="m-t-0"><a
                                                        ...
                                                        href="{{ route('designer.employees.show', $reply->user_id) }}"
                                                        @elseif($reply->user->hasRole('client'))
                                                        href="{{ route('designer.clients.show', $reply->user_id) }}"
                                                        @endif
...
<script>
    ...
    $('#submit-ticket').click(function () {
        ...
        $.easyAjax({
            url: '{{route('designer.tickets.update', $ticket->id)}}',
    ...
    $('#close-ticket').click(function () {
        ...
        $.easyAjax({
            url: '{{route('designer.tickets.closeTicket', $ticket->id)}}',
            type: "POST",
    ...
    $('#reopen-ticket').click(function () {
        ...
        $.easyAjax({
            url: '{{route('designer.tickets.reopenTicket', $ticket->id)}}',
            type: "POST",
            data: {'_token': "{{ csrf_token() }}"}
        })
    });
