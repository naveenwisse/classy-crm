    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.all-invoices.index') }}">{{ $pageTitle }}</a></li>
...
<script>
    ...
    $('#save-form').click(function () {
        ...
        $.easyAjax({
            url: '{{route('designer.all-invoices.update', $invoice->id)}}',
...
//console.log(total);
    ...
    $('.add-product').on('click', function(event) {
        ...
        var id = $(this).data('pk');
        $.easyAjax({
            url:'{{ route('designer.all-invoices.update-item') }}',
            type: "GET",
            data: { id: id },
