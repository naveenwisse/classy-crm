                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            @if($user->can('add_invoices'))
                                <a href="{{ route('designer.all-invoices.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.invoices.addInvoice') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @endif
                ...
                <div class="modal-body">
                    <div class="row" id="file-dropzone">
                        <div class="row m-b-20" id="file-dropzone">
                            <div class="col-md-12">
                                <form action="{{route('designer.invoiceFile.store')}}"
                                      class="dropzone"
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.all-invoices.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('designer.all-invoices.data') !!}?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status + '&projectID=' + projectID,
            "order": [[ 0, "desc" ]],
            language: {
