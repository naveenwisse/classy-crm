    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.all-invoices.index') }}">@lang("app.menu.invoices")</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="text-right">
                                ...
                                <a class="btn btn-default btn-outline"
                                   href="{{ route('designer.all-invoices.download', $invoice->id) }}"> <span><i class="fa fa-file-pdf-o"></i> @lang('modules.invoices.downloadPdf')</span> </a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function showPayments() {
        var url = '{{route('designer.all-invoices.payment-detail', $invoice->id)}}';
