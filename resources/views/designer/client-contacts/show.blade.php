    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.clients.index') }}">{{ $pageTitle }}</a></li>
                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li><a href="{{ route('designer.clients.projects', $client->id) }}"><span>@lang('app.menu.projects')</span></a></li>
                                <li><a href="{{ route('designer.clients.invoices', $client->id) }}"><span>@lang('app.menu.invoices')</span></a></li>
                                <li class="tab-current"><a href="{{ route('designer.contacts.show', $client->id) }}"><span>@lang('app.menu.contacts')</span></a></li>
                            </ul>
                        </nav>
                    </div>
...
<script>
    var table = $('#contacts-table').dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '{!! route('designer.contacts.data', $client->id) !!}',
        deferRender: true,
        language: {
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('designer.contacts.store')}}',
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('designer.contacts.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    $('body').on('click', '.edit-contact', function () {
        ...
        var url = '{{ route('designer.contacts.edit', ':id')}}';
        url = url.replace(':id', id);
