                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            @if($user->can('add_notice'))
                                <a href="{{ route('designer.notices.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.notices.addNotice') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @endif
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.notices.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable () {
        ...
        table = $('#notice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('designer.notices.data') !!}?startDate=' + startDate + '&endDate=' + endDate,
            language: {
