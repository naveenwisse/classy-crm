                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="{{ route('designer.files.show', $project->id) }}"><span>@lang('modules.projects.files')</span></a> </li>
                                ...
                                <div class="col-md-12" id="files-list-panel">
                                    <div class="white-box">
                                        ...
                                        <div class="row m-b-20 hide" id="file-dropzone">
                                            <div class="col-md-12">
                                                <form action="{{ route('designer.files.store') }}" class="dropzone"
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <a href="{{ route('designer.files.download', $file->id) }}"
...
//        maxFilesize: 2, // MB,
    ...
    $('.thumbnail').on('click', function(event) {
        ...
        $.easyAjax({
            type: 'GET',
            url: "{{ route('designer.files.thumbnail') }}",
            data: {
                id: projectID
            },
            success: function (response) {
