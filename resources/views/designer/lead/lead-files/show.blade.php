                    ...
                    <div class="white-box">
                        <nav>
                            <ul>
                                ...
                                <li ><a href="{{ route('designer.proposals.show', $lead->id) }}"><span>@lang('modules.lead.proposal')</span></a></li>
                                <li class="tab-current"><a href="{{ route('designer.lead-files.show', $lead->id) }}"><span>@lang('modules.lead.file')</span></a></li>
                                ...
                                <div class="col-md-12" id="files-list-panel">
                                    <div class="white-box">
                                        ...
                                        <div class="row m-b-20 hide" id="file-dropzone">
                                            <div class="col-md-12">
                                                <form action="{{ route('designer.lead-files.store') }}" class="dropzone"
                                                        ...
                                                        <li class="list-group-item">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    @endif
                                                                    &nbsp;&nbsp;
                                                                    <a href="{{ route('designer.lead-files.download', $file->id) }}"
...
//        maxFilesize: 2, // MB,
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('designer.lead-files.destroy',':id') }}";
    ...
    $('.thumbnail').on('click', function(event) {
        ...
        $.easyAjax({
            type: 'GET',
            url: "{{ route('designer.lead-files.thumbnail') }}",
            data: {
              id: leadID
            },
            success: function (response) {
