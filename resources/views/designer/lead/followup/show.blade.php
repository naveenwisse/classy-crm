                        ...
                        <nav>
                            <ul>
                                ...
                                @if($user->can('edit_lead'))
                                    ...
                                    <li class="tab-current"><a href="{{ route('designer.leads.followup', $lead->id) }}"><span>@lang('modules.lead.followUp')</span></a></li>
                                @endif
                            </ul>
                        </nav>
                    </div>
...
<script type="text/javascript">
    ...
    $('#save-task').click(function () {
        $.easyAjax({
            url: '{{route('designer.leads.follow-up-store')}}',
    ...
    @if($lead->next_follow_up == 'yes')
        ...
        taskListPanel.on('click', '.edit-task', function () {
            ...
            var url = "{{route('designer.leads.follow-up-edit', ':id')}}";
    ...
    $('#sort-task, #hide-completed-tasks').change(function() {
        ...
        var url = "{{route('designer.leads.follow-up-sort')}}";
