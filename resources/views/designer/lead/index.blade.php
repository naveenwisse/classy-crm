    ...
    <script>
      ...
      function tableLoad() {
          ...
          table = $('#users-table').dataTable({
              ...
              destroy: true,
              stateSave: true,
              ajax: '{!! route('designer.leads.data') !!}?client='+client+'&followUp='+followUp,
              language: {
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('designer.leads.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
       ...
       function changeStatus(leadID, statusID){
           var url = "{{ route('designer.leads.change-status') }}";
           var token = "{{ csrf_token() }}";
...
//                        table._fnDraw();
        ...
        function followUp (leadID) {
            ...
            var url = '{{ route('designer.leads.follow-up', ':id')}}';
