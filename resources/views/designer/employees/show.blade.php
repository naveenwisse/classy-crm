    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.employees.index') }}">{{ $pageTitle }}</a></li>
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            @forelse($projects as $key=>$project)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td><a href="{{ route('designer.projects.show', $project->id) }}">{{ ucwords($project->project_name) }}</a></td>
                        ...
                        <table class="table">
                            ...
                            @forelse($employeeDocs as $key=>$employeeDoc)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('designer.employee-docs.download', $employeeDoc->id) }}"
...
<script>
    ...
    function showAdd() {
        var url = "{{ route('designer.employees.docs-create', [$employee->id]) }}";
    ...
    $('body').on('click', '.sa-params', function () {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('designer.employee-docs.destroy',':id') }}";
    ...
    function showTable() {
        ...
        var url = '{{ route('designer.employees.tasks', [$employee->id, ':hideCompleted']) }}';
...
<script>
    ...
    function showTable2(){
        ...
        var url = '{{ route('designer.employees.time-logs', [$employee->id]) }}';
