                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            @if($user->can('add_employees'))
                                <a href="{{ route('designer.employees.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.employees.addNewEmployee') <i class="fa fa-plus" aria-hidden="true"></i></a>
                            @endif
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.employees.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
        ...
        $('body').on('click', '.assign_role', function(){
            ...
            $.easyAjax({
                url: '{{route('designer.employees.assignRole')}}',
                type: "POST",
    ...
    function loadTable(){
        ...
        table = $('#users-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('designer.employees.data') !!}?employee=' + employee+ '&skill=' + skill,
            language: {
