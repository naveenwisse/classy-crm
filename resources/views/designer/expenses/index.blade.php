                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <a href="{{ route('designer.expenses.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.expenses.addExpense') <i class="fa fa-plus" aria-hidden="true"></i></a>
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('designer.expenses.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('designer.expenses.data') !!}?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status + '&employee=' + employee,
            "order": [[ 0, "desc" ]],
            language: {
