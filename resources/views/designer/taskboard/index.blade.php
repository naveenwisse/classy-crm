    ...
    <div class="row">
        <div class="white-box">
            ...
            <div class="row  m-b-15">
                <div class="col-md-5">
                    <a href="{{ route('designer.all-tasks.index') }}" class="btn btn-info btn-outline"><i class="fa fa-arrow-left"></i> @lang('modules.tasks.tasksTable')</a>
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('designer.taskboard.store')}}',
            container: '#addColumn',
    ...
    $('#edit-column-form').on('click', '#update-form', function () {
        ...
        var url = '{{route('designer.taskboard.update', ':id')}}';
    ...
    function loadData () {
        ...
        var url = '{{route('designer.taskboard.index')}}?startDate=' + startDate + '&endDate=' + endDate +'&clientID='+clientID +'&assignedBY='+ assignedBY+'&assignedTo='+ assignedTo+'&projectID='+ projectID;
