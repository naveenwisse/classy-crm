    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.proposals.index') }}">{{ $pageTitle }}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <input disabled type="text" class="form-control" value="{{ $lead->company_name }}">
...
<script>
    ...
    $('#save-form').click(function(){
        ...
        $.easyAjax({
            url:'{{route('designer.proposals.store')}}',
