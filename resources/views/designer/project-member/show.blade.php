                    ...
                    <div class="white-box">
                        ...
                        <nav>
                            <ul>
                                ...
                                <li class="tab-current"><a href="{{ route('designer.project-members.show', $project->id) }}"><span>@lang('modules.projects.members')</span></a></li>
...
<script type="text/javascript">
    ...
    $('#save-members').click(function () {
        $.easyAjax({
            url: '{{route('designer.project-members.store')}}',
    ...
    $('body').on('click', '.delete-members', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('designer.project-members.destroy',':id') }}";
