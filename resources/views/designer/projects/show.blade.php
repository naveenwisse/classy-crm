...
{{--                        <nav>--}}
{{--                            <ul>--}}
{{--                                <li class="tab-current"><a href="{{ route('designer.projects.show', $project->id) }}"><span>@lang('modules.projects.overview')</span></a>--}}
{{--                                </li>--}}
                                                ...
                                                <div class="panel-wrapper collapse in">
                                                    <div class="panel-body">
                                                        <dl>
                                                            ...
                                                            <dd class="m-b-10">{{ ucwords($project->address1) }}</dd>
                                                            <dt>@lang('modules.projects.address') 2</dt>
                                                            <dd class="m-b-10">{{ ucwords($project->address2) }}</dd>
...
//    })();
    ...
    $('#timer-list').on('click', '.stop-timer', function () {
       var id = $(this).data('time-id');
        var url = '{{route("designer.all-time-logs.stopTimer", ":id")}}';
