    ...
    <div class="row">
        ...
        <div class="sttabs tabs-style-line col-md-12">
            <div class="white-box">
                <nav>
                    <ul>
                        <li  class="tab-current"><a href="{{ route('designer.leaves.index') }}"><span>@lang('modules.leaves.myLeaves')</span></a>
                        </li>
                        <li><a href="{{ route('designer.leaves-dashboard.index') }}"><span>@lang('app.menu.dashboard')</span></a>
                        </li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 text-right">
                        <div class="form-group">
                            <a href="{{ route('designer.leaves.create') }}" class="btn btn-sm btn-success waves-effect waves-light">
...
<script>
    ...
    function getEventDetail(id) {
        var url = '{{ route('designer.leaves.show', ':id')}}';
    ...
    $(function() {
        var table = $('#leaves-table').dataTable({
            ...
            serverSide: true,
            stateSave: true,
            ajax: '{!! route('designer.leaves.data') !!}',
            language: {
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                var url = "{{ route('designer.leaves.destroy',':id') }}";
                url = url.replace(':id', id);
