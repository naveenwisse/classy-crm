...
<script>
    ...
    $('#submitBtn').on('click', function (e) {
        ...
        if (submitText == "" || submitText == undefined || submitText == null) {
            ...
            var url = "{{ route('designer.user-chat.message-submit') }}";
    ...
    $("#userSearch").keyup(function (e) {
        var url = "{{ route('designer.user-chat.user-search') }}";
    ...
    function getChatData(id, dpName, scroll) {
        ...
        var url = "{{ route('designer.user-chat.index') }}";
    ...
    $('#new-chat').click(function () {
        var url = '{{ route('designer.user-chat.create')}}';
