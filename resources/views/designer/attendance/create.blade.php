    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('designer.attendances.index') }}">{{ $pageTitle }}</a></li>
...
<script>
    ...
    function checkHoliday() {
        ...
        $.easyAjax({
            url: '{{route('designer.attendances.check-holiday')}}',
            type: "GET",
            data: {
                date: selectedDate,
                _token: token
    ...
    function showTable(){
        table = $('#attendance-table').dataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{!! route('designer.attendances.data') !!}",
                data: function (d) {
    ...
    $('#attendance-table').on('click', '.save-attendance', function () {
        ...
        $.easyAjax({
            url: '{{route('designer.attendances.storeAttendance')}}',
            type: "POST",
   ...
   function attendanceDetail(id,attendanceDate) {
       var url = "{{ route('designer.attendances.detail') }}?userID="+id+"&date="+attendanceDate;
