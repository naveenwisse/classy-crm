...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <a href="{{ route('designer.attendances.create') }}"
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="white-box bg-inverse text-white">
                <div class="row">
                    <div class="col-md-4">
...
<script>
    ...
    function showTable() {
        ...
        //refresh counts
        var url = '{!!  route('designer.attendances.refreshCount') !!}';
        ...
        //refresh datatable
        var url2 = '{!!  route('designer.attendances.employeeData') !!}';
    ...
    $('#attendanceData').on('click', '.delete-attendance', function(){
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                var url = "{{ route('designer.attendances.destroy',':id') }}";
