<ul class="nav tabs-vertical">
    <li class="tab @if(\Illuminate\Support\Facades\Route::currentRouteName() == 'admin.settings.index') active @endif">
        <a href="{{ route('admin.settings.index') }}">@lang('app.menu.accountSettings')</a>
        <ul class="nav nav-second-level">
            <li><a href="{{ route('admin.report-settings.lead') }}">@lang('app.menu.leadReportSetting')</a></li>
            <li><a href="{{ route('admin.report-settings.project') }}">@lang('app.menu.projectReportSetting')</a></li>
            <li><a href="{{ route('admin.report-settings.appointment') }}">@lang('app.menu.appointmentReportSetting')</a></li>
        </ul>
    </li>
