                                                        ...
                                                        <div class="message-center">
                                                            ...
                                                            <a href="#">
                                                                <div class="user-img">
                                                                    ...
                                                                    '<img src="'.asset('img/default-profile-2.png').'" alt="user"
                                                    ...
                                                    <div class="panel-body">
                                                        <ol class="list-task list-group" data-role="tasklist">
                                                            @forelse($recentFiles as $key=>$file)
                                                                <li class="list-group-item" data-role="task">
                                                                    {{ $file->filename }} <a target="_blank" href="{{ asset_url('project-files/'.$project->id.'/'.$file->hashname) }}" class="btn btn-info btn-circle"><i class="fa fa-search"></i></a>
                                                                </li>
                                                            @empty
                                                                <li class="list-group-item" data-role="task">
