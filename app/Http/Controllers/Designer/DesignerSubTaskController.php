...
class DesignerSubTaskController extends DesignerBaseController
{
    ...
    public function create(Request $request)
    {
        ...
        return view('designer.sub_task.create', $this->data);
    }
    ...
    public function store(StoreSubTask $request)
    {
        ...
        $view = view('designer.sub_task.show', $this->data)->render();
