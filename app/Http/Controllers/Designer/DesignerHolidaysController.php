...
class DesignerHolidaysController extends DesignerBaseController
{
    ...
    public function index(IndexRequest $request)
    {
        ...
        return View::make('designer.holidays.index', $this->data);
    }
    ...
    public function viewHoliday($year)
    {
        ...
        $view = View::make('designer.holidays.holiday-view', $this->data)->render();
    ...
    public function create()
    {
        ...
        return View::make('designer.holidays.create', $this->data);
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        return Reply::redirect(route('designer.holidays.index'), __('messages.holidayAddedSuccess'));
    }
    ...
    public function show($id)
    {
        ...
        return view('designer.holidays.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('designer.holidays.edit', $this->data);
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Redirect::route('designer.holidays.index');
    }
    ...
    public function destroy(DeleteRequest $request, $id)
    {
        ...
        Holiday::destroy($id);
        return Reply::redirect(route('designer.holidays.index'), __('messages.holidayDeletedSuccess'));
    }
    ...
    public function holidayCalendar(Request $request, $year = null){
        ...
        return view('designer.holidays.holiday-calendar', $this->data);
    }
    ...
    public function markHoliday()
    {
        ...
        return View::make('designer.holidays.mark-holiday', $this->data);
    }
