...
class DesignerClientContactController extends DesignerBaseController
{
    ...
    public function show($id) {
        ...
        return view('designer.client-contacts.show', $this->data);
    }
    ...
    public function edit($id) {
        ...
        return view('designer.client-contacts.edit', $this->data);
    }
