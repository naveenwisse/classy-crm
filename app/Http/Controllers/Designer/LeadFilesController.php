...
class LeadFilesController extends DesignerBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->view == 'list') {
            $view = view('designer.lead.lead-files.ajax-list', $this->data)->render();
        } else {
            $view = view('designer.lead.lead-files.thumbnail-list', $this->data)->render();
        }
    ...
    public function show($id)
    {
        ...
        return view('designer.lead.lead-files.show', $this->data);
    }
