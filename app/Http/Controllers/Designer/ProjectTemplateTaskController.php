...
class ProjectTemplateTaskController extends DesignerBaseController
{
    ...
    public function __construct() {
        ...
        $this->pageTitle = __('app.menu.projectTemplateTask');
    }
    ...
    public function store(StoreTask $request)
    {
        ...
        $view = view('designer.project-template.tasks.task-list-ajax', $this->data)->render();
    ...
    public function show($id)
    {
        ...
        return view('designer.project-template.tasks.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $view = view('designer.project-template.tasks.edit', $this->data)->render();
