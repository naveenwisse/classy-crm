...
class DesignerTicketsAgentController extends DesignerBaseController
{
    ...
    public function index() {
        ...
        if(!$isAgent){
            return redirect(route('designer.tickets.index'));
        }
        ...
        return view('designer.tickets.agent.index', $this->data);
    }
    ...
    public function edit($id) {
        ...
        return view('designer.tickets.agent.edit', $this->data);
    }
    ...
    public function data($startDate = null, $endDate = null, $status = null, $priority = null, $channelId = null, $typeId = null) {
        ...
        return DataTables::of($tickets)
            ->addColumn('action', function($row){
                return '<a class="btn btn-info" href="' . route("designer.ticket-agent.edit", $row->id) . '" ><i class="fa fa-eye"></i> '.__('modules.client.viewDetails').'</a>';
            })
