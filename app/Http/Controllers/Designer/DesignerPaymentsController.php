...
class DesignerPaymentsController extends DesignerBaseController
{
    ...
    public function index() {
        ...
        return view('designer.payments.index', $this->data);
    }
        ...
        return DataTables::of($payments)
            ->addColumn('action', function ($row) {
                ...
                if($this->user->can('edit_payments')){
                    $action.= '<a href="' . route("designer.payments.edit", $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="btn btn-info btn-circle"><i class="fa fa-pencil"></i></a>';
                }
    ...
    public function create(){
        ...
        return view('designer.payments.create', $this->data);
    }
    ...
    public function store(StorePayment $request){
        ...
        return Reply::redirect(route('designer.payments.index'), __('messages.paymentSuccess'));
    }
    ...
    public function edit($id){
        ...
        return view('designer.payments.edit', $this->data);
    }
    ...
    public function payInvoice($invoiceId){
        ...
        return view('designer.payments.pay-invoice', $this->data);
    }
