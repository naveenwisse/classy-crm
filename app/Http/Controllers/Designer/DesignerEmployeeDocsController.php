...
class DesignerEmployeeDocsController extends DesignerBaseController
{
    ...
    public function __construct() {
        ...
        $this->pageTitle = __('app.menu.employeeDocs');
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        $view = view('designer.employees.docs-list', $this->data)->render();
