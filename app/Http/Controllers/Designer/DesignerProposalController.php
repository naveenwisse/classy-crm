...
class DesignerProposalController extends DesignerBaseController
{
    ...
    public function Index() {
        ...
        return view('designer.proposals.index', $this->data);
    }

    public function show($id) {

        $this->lead = Lead::where('id', $id)->first();
        return view('designer.proposals.show', $this->data);
    }
        ...
        return DataTables::of($lead)
            ->addColumn('action', function ($row) {
                ...
                <ul role="menu" class="dropdown-menu">
                  <li><a href="' . route("designer.proposals.download", $row->id) . '" ><i class="fa fa-download"></i> Download</a></li>
                  <li><a href="' . route("designer.proposals.edit", $row->id) . '" ><i class="fa fa-pencil"></i> Edit</a></li>
    ...
    public function create($leadID = null) {
        ...
        return view('designer.proposals.create', $this->data);
    }
...
//        $notifyUser->notify(new NewProposal($proposal));
        ...
        $this->logSearchEntry($proposal->id, 'Proposal #'.$proposal->id, 'designer.proposals.edit');

        return Reply::redirect(route('designer.proposals.show', $proposal->lead_id), __('messages.proposalCreated'));
    ...
    public function edit($id) {
        ...
        return view('designer.proposals.edit', $this->data);
    }
...
//        $notifyUser->notify(new NewProposal($proposal));
        ...
        return Reply::redirect(route('designer.proposals.show', $proposal->id), __('messages.proposalUpdated'));
    ...
    public function download($id) {
        ...
        $pdf->loadview('designer.proposals.proposal-pdf', $this->data);
