...
use App\Http\Requests\Leaves\StoreNote;
use App\Http\Requests\Leaves\UpdateNote;
use App\Leave;
use App\LeaveType;
...
class DesignerLeaveDashboardController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        return view('designer.leave-dashboard.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('designer.leave-dashboard.create', $this->data);
    }
    ...
    public function store(StoreNote $request)
    {
        ...
        if($request->duration == 'multiple'){
            ...
            return Reply::redirect(route('designer.leaves-dashboard.index'), __('messages.leaveAssignSuccess'));
        }
        else{
            $leave = new Leave();
            $leave->user_id = $request->user_id;
    ...
    public function show($id)
    {
        ...
        return view('designer.leave-dashboard.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->leaveTypes = LeaveType::all();
        $this->leave = Leave::findOrFail($id);
        $view = view('designer.leave-dashboard.edit', $this->data)->render();
