...
class DesignerEventReportController extends DesignerBaseController
{
    ...
    public function index() {
        ...
        return view('designer.reports.events.index', $this->data);
    }
    ...
    public function data($startDate = null, $endDate = null, $type = null) {
        ...
        $events = Event::leftJoin('event_types', 'event_types.id', 'events.event_type')
                ...
                ->select('events.id', 'events.event_name','event_types.type as event_type', 'event_status.name as event_status', 'events.status_id', 'events.start_date_time', 'events.end_date_time', 'events.created_at');
    ...
    public function export($startDate = null, $endDate = null, $type=null) {
        ...
        $exportArray[] = ['ID', 'Appointment Name', 'Appointment Type', 'Starts On', 'Ends On', 'Created On', 'Status'];
