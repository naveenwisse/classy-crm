...
class DesignerAllTimeLogController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        return view('designer.time-log.index', $this->data);
    }
    ...
    public function edit($id) {
        ...
        return view('designer.time-log.edit', $this->data);
    }
    ...
    public function showActiveTimer()
    {
        ...
        return view('designer.time-log.show-active-timer', $this->data);
    }
    ...
    public function stopTimer(Request $request){
        ...
        $this->activeTimers = ProjectTimeLog::whereNull('end_time')
            ->get();
        $view = view('designer.time-log.active-timers', $this->data)->render();
        $buttonHtml = '';
