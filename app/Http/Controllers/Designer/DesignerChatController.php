 ...
 */
class DesignerChatController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        return view('designer.user-chat.index', $this->data);
    }
    ...
    public function userChatData($chatDetails)
    {
        ...
        $chatMessage .= view('designer.user-chat.ajax-chat-list', $this->data)->render();
    ...
    public function postChatMessage(ChatStoreRequest $request)
    {
        ...
        $users = view('designer.user-chat.ajax-user-list', $this->data)->render();
    ...
    public function create() {
        ...
        return view('designer.user-chat.create', $this->data);
    }
