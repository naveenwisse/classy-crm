 ...
 */
class DesignerStickyNoteController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        if(request()->ajax())
        {
            return   view('designer.sticky-note.note-ajax', $this->data);

        }

        return view('designer.sticky-note.index', $this->data);
    }
    ...
    public function create()
    {
        $this->noteDetail = [];
         ...
         return view('designer.sticky-note.create-edit', $this->data);
    }
