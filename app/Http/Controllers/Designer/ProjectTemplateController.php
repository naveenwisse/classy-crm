...
class ProjectTemplateController extends DesignerBaseController
{

    public function __construct() {
        parent::__construct();
        $this->pageTitle = __('app.menu.projectTemplate');
    ...
    public function index() {
        return view('designer.project-template.index', $this->data);
    }
    ...
    public function create() {
        ...
        return view('designer.project-template.create', $this->data);
    }
    ...
    public function store(StoreProject $request) {
        ...
        return Reply::redirect(route('designer.project-template.index'), __('modules.projectTemplate.projectUpdated'));
    }
    ...
    public function show($id) {
        ...
        return view('designer.project-template.show', $this->data);
    }
    ...
    public function edit($id) {
        ...
        return view('designer.project-template.edit', $this->data);
    }
    ...
    public function update(StoreProject $request, $id) {
        ...
        return Reply::redirect(route('designer.project-template.index', $id), __('messages.projectUpdated'));
    }
    ...
    public function data(Request $request) {
        ...
        return DataTables::of($projects)
            ->addColumn('action', function ($row) {
                return '<a href="' . route('designer.project-template.edit', [$row->id]) . '" class="btn btn-info btn-circle"
                      data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>

                      <a href="' . route('designer.project-template.show', [$row->id]) . '" class="btn btn-success btn-circle"
            ...
            ->addColumn('members', function ($row) {
                ...
                $members.= '<br><br><a class="font-12" href="'.route('designer.project-template-member.show', $row->id).'"><i class="fa fa-plus"></i> '.__('modules.projectTemplate.addMemberTitle').'</a>';
                return $members;
            })
            ->editColumn('project_name', function ($row) {
                return '<a href="' . route('designer.project-template.show', $row->id) . '">' . ucfirst($row->project_name) . '</a>';
            })
