...
class ProjectMemberTemplateController extends DesignerBaseController
{

    public function __construct() {
        parent::__construct();
        $this->pageIcon = 'icon-layers';
        $this->pageTitle = __('app.menu.projectTemplateMember');
    }
    ...
    public function show($id)
    {
        ...
        return view('designer.project-template.project-member.create', $this->data);
    }
