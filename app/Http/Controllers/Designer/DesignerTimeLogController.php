...
class DesignerTimeLogController extends DesignerBaseController
{
    ...
    public function create()
    {
        ...
        return view('designer.time-log.create', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        return view('designer.time-log.show', $this->data);
    }
    ...
    public function showTomeLog($id)
    {
        ...
        return view('designer.time-log.show-log', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('designer.time-log.edit-project-log', $this->data);
    }
