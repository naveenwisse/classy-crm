...
class DesignerLeavesController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        return view('designer.leaves.index', $this->data);
    }

    public function create()
    {
        $this->leaveTypes = LeaveType::all();
        return view('designer.leaves.create', $this->data);
    }
    ...
    public function store(StoreNote $request)
    {
        ...
        return Reply::redirect(route('designer.leaves.index'), __('messages.leaveAssignSuccess'));
    }

    public function show($id)
    {
        $this->leave = Leave::findOrFail($id);
        return view('designer.leaves.show', $this->data);
    }
    ...
    public function edit($id)
    {
        $this->leaveTypes = LeaveType::all();
        $this->leave = Leave::findOrFail($id);
        $view = view('designer.leaves.edit', $this->data)->render();
