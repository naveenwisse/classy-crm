...
class DesignerProjectReportController extends DesignerBaseController
{
    ...
    public function index() {
        ...
        return view('designer.reports.projects.index', $this->data);
    }
    ...
    public function data($startDate = null, $endDate = null) {
        ...
        $projects = Project::leftJoin('clients', 'clients.id', 'projects.client_id')
                ->select('projects.id', 'projects.project_name','clients.first_name as client_first_name', 'clients.last_name as client_last_name', 'projects.sales_price','projects.created_at', 'projects.status');
        ...
        $projects->where('projects.user_id', '=', $this->userDetail->id);
    ...
    public function export($startDate = null, $endDate = null) {
        ...
        $exportArray[] = ['ID', 'Project Name', 'Client', 'Sales Price','Created On', 'Status'];
