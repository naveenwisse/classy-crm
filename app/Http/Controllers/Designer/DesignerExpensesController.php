 ...
 */
class DesignerExpensesController extends DesignerBaseController
{
    ...
    {
        return view('designer.expenses.index', $this->data);
    }
        ...
        $dataTable =  DataTables::of($payments)
            ->addColumn('action', function ($row) {
                ...
                if ($row->status == 'pending' && $this->user->can('edit_expenses')) {
                    $html .= '<a href="' . route("designer.expenses.edit", $row->id) . '" data-toggle="tooltip" data-original-title="Edit" class="btn btn-info btn-circle"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;';
                }
    ...
    public function create(){
        ...
        return view('designer.expenses.create', $this->data);
    }
    ...
    public function store(StoreExpense $request){
        ...
        return Reply::redirect(route('designer.expenses.index'), __('messages.expenseSuccess'));
    }
    ...
    public function edit($id) {
        ...
        return view('designer.expenses.edit', $this->data);
    }
    ...
    public function update(StoreExpense $request, $id){
        ...
        return Reply::redirect(route('designer.expenses.index'), __('messages.expenseUpdateSuccess'));
    }
