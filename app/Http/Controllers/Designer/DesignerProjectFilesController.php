 ...
 */
class DesignerProjectFilesController extends DesignerBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->view == 'list') {
            $view = view('designer.project-files.ajax-list', $this->data)->render();
        } else {
            $view = view('designer.project-files.thumbnail-list', $this->data)->render();
        }
    ...
    public function show($id)
    {
        ...
        return view('designer.project-files.show', $this->data);
    }
