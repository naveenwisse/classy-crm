...
class DesignerTicketsController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        if($this->user->can('view_tickets')){
            ...
            return view('designer.tickets.index-admin', $this->data);
        }
        return view('designer.tickets.index', $this->data);
    }
    ...
    public function create()
    {
        if($this->user->can('add_tickets')){
            ...
            return view('designer.tickets.create-admin', $this->data);
        }
        return view('designer.tickets.create', $this->data);
    ...
    public function store(StoreTicketRequest $request)
    {
        ...
        return Reply::redirect(route('designer.tickets.index'), __('messages.ticketAddSuccess'));
    }
    ...
    public function edit($id)
    {
        if($this->user->can('add_tickets')){
            ...
            $this->channels = TicketChannel::all();
            $this->templates = TicketReplyTemplate::all();
            return view('designer.tickets.edit-admin', $this->data);
        }
        $this->ticket = Ticket::findOrFail($id);
        return view('designer.tickets.edit', $this->data);
    }
    ...
    public function update(UpdateTicketRequest $request, $id)
    {
        ...
        $reply->save();
        $this->reply = $reply;
        $lastMessage = view('designer.tickets.last-message', $this->data)->render();
    ...
    public function data() {
        ...
        return DataTables::of($tickets)
            ->addColumn('action', function($row){
                return '<a href="' . route("designer.tickets.edit", $row->id) . '" class="btn btn-info" ><i class="fa fa-eye"></i> '.__('modules.client.viewDetails').'</a>';
            })
    ...
    public function closeTicket($id){
        ...
        return Reply::redirect(route('designer.tickets.index'), __('messages.ticketReplySuccess'));
    }
    ...
    public function adminData($startDate = null, $endDate = null, $agentId = null, $status = null, $priority = null, $channelId = null, $typeId = null) {
        ...
        return DataTables::of($tickets)
            ->addColumn('action', function($row){
                ...
                if($this->user->can('view_tickets')){
                    $action.= '<li><a href="' . route("designer.tickets.edit", $row->id) . '" ><i class="fa fa-eye"></i> '.__('modules.client.viewDetails').'</a></li>';
                }

                if($this->user->can('edit_tickets')){
                    $action.= '<li><a href="' . route("designer.tickets.edit", $row->id) . '" ><i class="fa fa-pencil"></i> Edit</a></li>';
                }
