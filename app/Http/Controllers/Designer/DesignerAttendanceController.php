...
class DesignerAttendanceController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        return view('designer.attendance.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('designer.attendance.create', $this->data);
    }
    ...
    public function employeeData(Request $request, $startDate = null, $endDate = null, $userId = null){
        ...
        // Getting View data
        $view = view('designer.attendance.user_attendance', ['dateWiseData' => $dateWiseData,'global' => $this->global])->render();
    ...
    public function data(Request $request){
        ...
        return DataTables::of($attendances)
            ->editColumn('id', function ($row) {
                return view('designer.attendance.attendance_list', ['row' => $row, 'global' => $this->global, 'maxAttandenceInDay' => $this->maxAttandenceInDay])->render();
            })
            ->rawColumns(['id'])
            ->removeColumn('name')
    ...
    public function attendanceDetail(Request $request)
    {
        ...
        return view('designer.attendance.attendance-detail', $this->data)->render();
    }
