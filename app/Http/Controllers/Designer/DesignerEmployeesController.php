...
class DesignerEmployeesController extends DesignerBaseController
{
    ...
    public function index()
    {
        ...
        return view('designer.employees.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('designer.employees.create', $this->data);
    }
    ...
    public function store(StoreRequest $request) {
        ...
        return Reply::redirect(route('designer.employees.index'), __('messages.employeeAdded'));
    }
    ...
    public function show($id) {
        ...
        $this->projects = Project::select('projects.id', 'projects.project_name', 'projects.deadline', 'projects.completion_percent')
            ...
            ->get();
        return view('designer.employees.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('designer.employees.edit', $this->data);
    }
    ...
    public function update(UpdateRequest $request, $id) {
        ...
        return Reply::redirect(route('designer.employees.index'), __('messages.employeeUpdated'));
    }
    ...
    public function data(Request $request) {
        ...
        return DataTables::of($users)
            ->addColumn('action', function ($row) {
                ...
                if ($this->user->can('edit_employees')) {
                    $action .= ' <a href="' . route('designer.employees.edit', [$row->id]) . '" class="btn btn-info btn-circle"
                      data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>';
                }

                if ($this->user->can('view_employees')) {
                    $action .= ' <a href="' . route('designer.employees.show', [$row->id]) . '" class="btn btn-success btn-circle"
            ...
            ->editColumn('name', function ($row) {
                if ($row->hasRole('admin')) {
                    return '<a href="' . route('designer.employees.show', $row->id) . '">' . ucwords($row->name) . '</a><br> <label class="label label-danger">admin</label>';
                }
                if ($row->hasRole('project_admin')) {
                    return '<a href="' . route('designer.employees.show', $row->id) . '">' . ucwords($row->name) . '</a><br> <label class="label label-info">project admin</label>';
                }
                return '<a href="' . route('designer.employees.show', $row->id) . '">' . ucwords($row->name) . '</a>';
            })
    ...
    public function docsCreate(Request $request, $id) {
        $this->employeeID = $id;
        return view('designer.employees.docs-create', $this->data);
    }
